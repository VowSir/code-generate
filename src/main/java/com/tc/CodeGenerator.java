...
public class CodeGenerator {
    ...
    // 需要生产的表名
    public static final String[] TABLE_LIST = {"sys_user"};
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:postgresql://192.168.0.203:5432/msp_dev");
        dsc.setSchemaName("public");
        dsc.setDriverName("org.postgresql.Driver");
        dsc.setUsername("farmer");
        dsc.setPassword("q1w2e3..");
